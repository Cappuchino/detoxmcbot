...
TOKEN = os.environ['NTMzNjkwNTM2MzQ3ODI4MjI0.DzNijw.-FbIvhDAmzqyGO5EtqW1PSS4qPI'] # The token is also substituted for security reasons
...
async def on_ready():
    ...
    print('------')
    await client.change_presence(game=discord.Game(name="DetoxMC | Type !help"))
